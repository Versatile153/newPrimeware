...
<head>
    ...
    <meta name="description" content="Primeswaretrades Trading Limited is a global leader in online trading and investing, providing thousands of clients worldwide with access to forex, contracts for difference (CFDs), stockbroking and bonds markets via award-winning platforms.">
...
#hero {
  width: 100%;
  height: 100vh;
  background: url(img/client.jpg) top center;
...
#herod {
  width: 100%;
  height: 70vh;
  background: url(img/bsv.jpeg) top center;
  background-size: cover;
  overflow: hidden;
  position: relative;
}
...
<body>
  ...
  <header id="header" class="d-flex align-items-center ">
    <div class="container-fluid container-xxl d-flex align-items-center">
      ...
      <div id="logo" class="me-auto">
        ...
        <h3><a href="about.html">Primewaretrades</a></h3>
       
      </div>

      <nav id="navbar" class="navbar order-last order-lg-0">
        <ul>
          <li><a class="nav-link scrollto active" href="/story">Company</a></li>
          <li><a class="nav-link scrollto" href="/career">Careers</a></li>
          <li><a class="nav-link scrollto" href="/register">Register</a></li>
        </ul>
        <i class="bi bi-list mobile-nav-toggle"></i>
      </nav><!-- .navbar -->
      <a class="buy-tickets scrollto" href="/"> Home</a>
      ...
      <div class="container" data-aos="fade-up">
        <div class="row">
          <div class="col-lg-6">
            ...
            <p class="text-white">As our understanding of the boundless potential of Bitcoin has developed and deepened, so too has our vision.</p>
        ...
        <div class="tab-content row justify-content-center" data-aos="fade-up" data-aos-delay="200">
          ...
          <div role="tabpanel" class="col-lg-9 tab-pane fade show active" id="day-1">
            ...
            <div class="row schedule-item">
              ...
              <div class="col-md-10">
                <h4 style="color:red;">We believe in learning to teach, and teaching to learn. Primewaretrades Media is our channel to educate; to connect with the world, to maintain the integrity of our perspective, and to share our intellectual truth.</h4>
                <p></p>
              </div>
            </div>
          </div>
  ...
  <section id="herod">
    <div class="hero-container" data-aos="zoom-in" data-aos-delay="100">
      ...
      <p class="mb-4 pb-0">By combining the power of Bitcoin and the Internet, we're building Primewaretrades Trading Limited, an alternative ecosystem. One that has sovereignty embedded in its blueprint and allows us to, finally, take ownership of our money.</p>
        ...
        <div class="row">
          <div class="col-lg-4 col-md-6">
            <div class="speaker" data-aos="fade-up" data-aos-delay="100">
              <img src="https://primestocktrades.com/img/micheal.jpg" alt="Speaker 1" class="img-fluid">
              <div class="details">
          ...
          <div class="col-lg-4 col-md-6">
            <div class="speaker" data-aos="fade-up" data-aos-delay="200">
              <img src="https://primestocktrades.com/img/david.jpg" alt="Speaker 2" class="img-fluid">
              <div class="details">
          ...
          <div class="col-lg-4 col-md-6">
            <div class="speaker" data-aos="fade-up" data-aos-delay="300">
              <img src="https://primestocktrades.com/img/nicola.jpg" alt="Speaker 3" class="img-fluid">
              <div class="details">
          ...
          <div class="col-lg-4 col-md-6">
            <div class="speaker" data-aos="fade-up" data-aos-delay="100">
              <img src="https://primestocktrades.com/img/lara.jpg" alt="Speaker 4" class="img-fluid">
              <div class="details">
          ...
          <div class="col-lg-4 col-md-6">
            <div class="speaker" data-aos="fade-up" data-aos-delay="200">
              <img src="https://primestocktrades.com/img/damien.jpg" alt="Speaker 5" class="img-fluid">
              <div class="details">
          ...
          <div class="col-lg-4 col-md-6">
            <div class="speaker" data-aos="fade-up" data-aos-delay="300">
              <img src="https://primestocktrades.com/img/james.jpg" alt="Speaker 6" class="img-fluid">
              <div class="details">
