...
>
  ...
  <thead>
    <tr>
      ...
      <th style="color:white;" scope="col">messages</th>
  ...
  <tbody>
      <!--@else-->
      <!--  <h2 style ="color:white; margin:auto;">No Messages yet</h2>-->
       @endif
      @if(count($my_mess)>0)
      @foreach($my_mess as $message)
      
       <tr>
      <th style="color:white;" scope="row">{{$message->id}}</th>
      <td style="color:white;">{{$message->email}}</td>
      <td style="color:white;">{{$message->message}}</td>
      <td style="color:white;">{{$message->created_at}}</td>
      <td><a class="btn btn-primary" href="/reply/{{$message->id}}"> reply </a></td>
