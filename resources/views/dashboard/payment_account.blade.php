...
<div class="dt-content-wrapper" style="    background-color:rgb(7, 7, 50)";>
    <div class="hide" id="active-tab" data-id="#tab-pane3" style="    background-color:rgb(7, 7, 50)";></div>
    <!-- Site Content -->
    <div class="dt-content" style="    background-color:rgb(7, 7, 50)";>
        <!-- Profile -->
        <div class="profile" style="    background-color:rgb(7, 7, 50)";>
                ...
                <div class="profile__banner-detail" >
                    ...
                    <div class="dt-avatar-wrapper">
                        ...
                        <img class="dt-avatar dt-avatar__shadow size-90 mr-sm-4"
                            src="https://primestocktrades.com/m_cust/dash/assets/dist/img/avatar.png" id="ppic" alt="Logo">
                        <!-- /avatar -->
            ...
            <div class="profile-content" >
                ...
                <div class="row">
                    ...
                    <div class="col-xl-12 order-xl-1">
                        ...
                        <!-- Card -->
                        <div class="card" style="    background-color:rgb(7, 7, 50)";>

                            <!-- Card Header -->
                            <div
                                class="card-header card-nav  border-bottom d-sm-flex justify-content-sm-between"  style="    background-color:rgb(7, 7, 50)"; color:white;>
                                <h3 style="color:white;" class="mb-2 mb-sm-n5">Account Details</h3>

                                <ul class="card-header-links nav nav-underline" role="tablist" style="color:white;">
                                    <li class="nav-item">
                                        <a style="color:white;" class="nav-link " href="/profile">My Profile</a>
                                    </li>
                                                                        <li class="nav-item">
                                        <a style="color:white;" class="nav-link active" href="/payment_account">Payment Account</a>
                                    </li>
                                                                        <li class="nav-item">
                                        <a style="color:white;" class="nav-link " href="/security">Security</a>
                                    </li>
                                </ul>
...
<input type="hidden" name="csrf_test_name" value="4e0186dbd34b7c0d1894efb685c6f1e8" />
                                                            ...
                                                            <div class="row">
                                                                <div class="col-md-6">
                                                                    ...
                                                                    <div class="form-group">
                                                                        ...
                                                                        <input type="text" value="versatile"
                                                            ...
                                                            <div class="row">
                                                                <div class="col-md-12">
                                                                    ...
                                                                    <div class="form-group">
                                                                        ...
                                                                        <input type="email" value="ecelestinee153@gmail.com"
                                                            ...
                                                            <div class="modal-dialog modal-dialog-centered" role="document">
                                                                ...
                                                                <div class="modal-content">
                                                                    ...
                                                                    <div class="modal-header">
                                                                        <h3 class="modal-title" id="model-8">Enter password to proceed</h3>
                                                            ...
                                                            <div class="row">
                                                                <div class="col-md-6">
                                                                    ...
                                                                    <div class="form-group">
                                                                        ...
                                                                        <select class="form-control" required name="payment_type" id="simple-select">
                                                        ...
                                                        <div class="modal fade display-n" id="form1-modal" tabindex="-1"
                                                            ...
                                                            <div class="modal-dialog modal-dialog-centered"
                                                                ...
                                                                <div class="modal-content">
                                                                    ...
                                                                    <div class="modal-header">
                                                                        <h3 class="modal-title" id="model-8">Enter password to proceed</h3>
                                                                        <button type="button" required class="close"
                                                                            data-dismiss="modal" aria-label="Close">
                                                                            <span aria-hidden="true">×</span>
                                                                        </button>
                                                                    </div>
                             ...
                             <input type="hidden" name="csrf_test_name" value="4e0186dbd34b7c0d1894efb685c6f1e8" />
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <inpu requiredt class="form-control " name="newPassword" type="password">
                                                    <label class="error" for="fname"></label>
                                                </div>
                                                <!-- /form group -->
                                                <!-- Form Group -->
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-footer">
                                                    ...
                                                    <button type="submit" id="activate-submit"
                                                        class="btn btn-primary btn-sm" data-loading-text="Processing data" data-title="Activate">Activate                                                    </button>
                                                </div>
                                                <!-- /modal footer -->
                                            </div>
                                            <!-- /modal content -->
...
<script data-cfasync="false" src="/cdn-cgi/scripts/5c5dd728/cloudflare-static/email-decode.min.js"></script><script src="https://primestocktrades.com/m_cust/dash/assets/dist/js/profile.js"></script>
<script src="https://primestocktrades.com/m_cust/dash/assets/dist/js/intlTelInput.js"></script>
<script src="https://primestocktrades.com/m_cust/dash/assets/dist/js/utils.js"></script>
<script>
