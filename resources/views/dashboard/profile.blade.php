                ...
                <header class="dt-header">
                    ...
                    <div class="dt-header__container">
                        ...
                        <div class="dt-brand">
                            ...
                            margin-top:-2rem;" src="{{ asset('/storage/images/JxZzyOwMTIiMwrL6YErxStgJCXHX2067rm32AiKW.png') }}"
                             alt="Logo"></a>
                            </span>
                            <!-- /brand logo -->
            ...
            <div class="profile__banner">
                ...
                <div class="profile__banner-detail">
                    ...
                    <div class="dt-avatar-wrapper">
                        ...
                        <span class="f-16"><a href="" class="__cf_email__" data-cfemail="14717771787167607d7a7171252127547379757d783a777b79"></a></span>
            ...
            <div class="profile-content">
                ...
                <div class="row">
                    ...
                    <div class="col-xl-12 order-xl-1">
                        ...
                        <!-- Card -->
                        <div class="card" style="    background-color:rgb(7, 7, 50)";color:white;>

                            <!-- Card Header -->
                            <div
                                class="card-header card-nav bg-transparent border-bottom d-sm-flex justify-content-sm-between" style="    background-color:rgb(7, 7, 50)";>
                                <h3 style="color:white;" class="mb-2 mb-sm-n5">Account Details</h3>

                                <ul class="card-header-links nav nav-underline" role="tablist">
                                    <li class="nav-item">
                                        <a style="color:white;" class="nav-link active" href="/profile">My Profile</a>
                                    </li>
                                                                        <li class="nav-item">
                                        <a style="color:white;" class="nav-link " href="/payment_account">Payment Account</a>
                                    </li>
                                                                        <li class="nav-item">
...
<input type="hidden" name="csrf_test_name" value="" />
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input required  class="form-control " name="cNewPassword" type="password">
                                                    <label class="error" for="fname"></label>
                                                </div>
                                                <!-- /form group -->
