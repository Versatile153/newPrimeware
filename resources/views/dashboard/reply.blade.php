                    ...
                    <div class="dt-header__container">
                        ...
                        <div class="dt-header__toolbar">
                            ...
                            <div class="search-box d-none d-lg-block">
                                                            <h1 class="dt-page__title mt-4" style="margin-left: -1.5em;">Home <span class="breadcrumb-arrow-right"></span> message body
...
>
           ...
           <form style="margin:auto;" action="/reply" method="post">
                 @csrf
      <div class="mb-3">
  <label for="exampleFormControlInput1" class="form-label">Message</label>
  
  <input readonly type="email" name="email" class="form-control" id="exampleFormControlInput1" placeholder="name@example.com" value="{{$mess->message}}" style="width:350px;">
   <input readonly type="email" name="user_id" class="form-control" id="exampleFormControlInput1" placeholder="message id" value="{{$mess->id}}" style="width:350px;">
</div>
<div class="mb-3">
  <label for="exampleFormControlTextarea1" class="form-label">Messsage Reply</label>
