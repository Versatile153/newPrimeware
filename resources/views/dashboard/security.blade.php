                        ...
                        <div class="dt-brand">
                            ...
                            <span class="dt-brand__logo">
                                <a class="dt-brand__logo-link" href="">
                                    <img width="" class="d-none d-sm-inline-block w-100" src="{{ asset('/storage/images/JxZzyOwMTIiMwrL6YErxStgJCXHX2067rm32AiKW.png') }}" alt="logo">
                                    <img class="dt-brand__logo-symbol d-sm-none" src="{{ asset('/storage/images/JxZzyOwMTIiMwrL6YErxStgJCXHX2067rm32AiKW.png') }}" alt="logo">
                                    </a>
                            </span>
                            <!-- /brand logo -->
...
<div class="dt-content-wrapper">
    <div class="hide" id="active-tab" data-id="#tab-pane2" ></div>
    <!-- Site Content -->
                    ...
                    <div class="col-xl-12 order-xl-1">
                        ...
                        <div class="card" style="    background-color:rgb(7, 7, 50)";>
                            ...
                            <div
                                ...
                                <h3 class="mb-2 mb-sm-n5" style="color:white;";>Account Details</h3>
                                ...
                                <ul class="card-header-links nav nav-underline" role="tablist">
                                    <li class="nav-item">
                                        ...
                                        <a style="color:white;" class="nav-link " href="/payment_account">Payment Account</a>
                                                                        ...
                                                                        <li class="nav-item">
                                        <a style="color:white;" class="nav-link active" href="/security">Security</a>
                                    </li>
                                </ul>
