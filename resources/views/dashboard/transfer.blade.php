    ...
    ->sum('amount');}}
                            ...
                            <div class="col-sm-4 col-12">
                                ...
                                <div class="dt-card dt-card__full-height text-dark">
                                    ...
                                    <div class="dt-card__body p-xl-8 py-sm-8 py-6 px-4">
                                        <span class="badge badge-secondary badge-top-right">
                                            Primeware personal Id                                       </span>
                                        <!-- Media -->
                                        <div class="media">

                                             <img style="width:55px;margin-right:1rem;" src="https://imgs.search.brave.com/0nvztXh1xOWAmK1kcsNbkMHeOLVIzo-j7lewUAi14tE/rs:fit:481:225:1/g:ce/aHR0cHM6Ly90c2Uz/Lm1tLmJpbmcubmV0/L3RoP2lkPU9JUC5m/SlhjZHVMVVlJV2ZT/b2NMNGtQTXdBSGFI/VCZwaWQ9QXBp">
                ...
                <div class="row">
                    ...
                    <div class="col-xl-12 col-12 order-xl-1">
                        ...
                        <div class="dt-card">
                                    ...
                                    <!-- Card Title-->
                                    <h2 class="card-title">Want to transfer funds to friends?</h2>
                                    <!-- Card Title-->
                                    <!-- Card Text-->
                                    <p class="card-text">
...
<div class="mb-3">
  <label for="exampleFormControlInput1" class="form-label">Receipient ID</label>
  <input type="number" required name="user_id" class="form-control" id="exampleFormControlInput1" placeholder="">
</div>
<div class="mb-3">
 <label for="exampleFormControlInput1" class="form-label">Enter Amount( min:0  max :{{  $totalEarnings}})</label>
  <input type="number" required name="amount" min="0" step="any" max="{{  $totalEarnings}}" class="form-control" id="exampleFormControlInput1" placeholder="">
</div>


<div class="mb-3">
  
  <input class="btn btn-primary" type="submit" name="" value="Transer">
</div>
</form>
                    <!-- /grid -->
