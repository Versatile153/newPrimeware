...
#hero {
  width: 100%;
  height: 70vh;
  background: url("https://media.istockphoto.com/id/1363777608/photo/two-professional-male-economists-looking-at-stock-charts-on-monitors-doing-altcoin-analysis.jpg?b=1&s=170667a&w=0&k=20&c=VRBVGvcrQz9nd2soe8MgBl64fi_f8Y1pwnZTfEtAL-U=") top center;
  background-size: cover;
  position: relative;
  padding: 0;
}
...
@media (max-width: 768px) {
  ...
  #hero h2 {
    ...
    margin-bottom: 30px;
     	...
     	<!-- ======= Hero Section ======= -->
  <section id="hero" style="color:white;">
    <div class="hero-container" data-aos="fade-up" data-aos-delay="150">
      ...
      <div class="container-fluid end-divider" style="color:white;">
    <div id="section1" class="container default-wd mobile-padding-top1">
        <div class="title">
        <h2><p style="padding-bottom:5px; font-size:28px!important;" style="color:white;">Trade Commodities with Primewaretrades Trading Limited</p></h2>
        </div>
        ...
        <div class="row fb-cus-row">
            ...
            <div class="text-block3 padding-30"><p> Trade in CFDs on a wide range of universal commodities, including gold (XAU), silver (XAG) and oil (CL, WTI) with a regulated broker provider giving you access to different asset classes,sophisticated risk management and trading tools.</p>
            </div>
               
            </div>
            <div class="col-sm-6 text_content-1 padding-left-40" style="padding-left:40px;">
            <div class="text-block1"><p class="para-cent trade-commodities-cont-subhead-padding" style="font-size:23px!important;">What are the benefits of commodities trading?</p>
...
<p>Leverage up to 30:1</p>
</li>
<div class="padding-15"></div>
<li class="list-item-default list-item-trade-commodities91">
<p>Choose from a wide range of commodities, such as energy, metals and agricultural products</p>
</li>
<div class="padding-15"></div>
<li class="list-item-default list-item-trade-commodities91">
...
<div class="padding-15"></div>
<li class="list-item-default list-item-trade-commodities91">
<p>Trade in any direction you think the markets will go. Sell and go short or buy to go long, maximizing trading opportunities and minimizing risks.</p>
</li>
<div class="padding-15"></div>
<li class="list-item-default list-item-trade-commodities91">
...
<div class="padding-15"></div>
<li class="list-item-default list-item-trade-commodities91">
<p>Hedge Risks - Hedge your investment risks with high-value assets, like gold (XAU), silver (XAG), and Oil (WTI / CL) </p>
</li>
<div class="padding-15"></div>
<li class="list-item-default list-item-trade-commodities91">
...
<div class="container-fluid" style="color:white;">
    <div id="top-ten-section" class="container default-wd">
        <div class="title">
            <h2><p class="hidden-xs" style="padding-bottom:5px; font-size:23px!important;">The Top Ten Commodities to Trade</p>
			</h2>
        </div>
		...
		<div class="row fb-cus-row">
            ...
            <div class="col-sm-6 text-content-1" style="padding-right:15px;" style="color:white;">
            <div class="text-block1"><p>Commodities are essentially the raw materials from which other goods are created; the basic building blocks of the global economy. Consequently, they often serve as an excellent investment vehicle. Commodities fall into two broad categories: hard commodities and soft commodities. </p>
            </div>
            <div style="color:white;" class="text-block2 padding-30"><p>Hard commodities are those that are mined from the earth or extracted from natural resources. This category includes metals such as gold, silver and iron, and energies such as oil, natural gas and coal. Soft commodities are agricultural products such as livestock and crops. <b>The commodity markets</b> are popular among traders. This is because they are highly volatile, a feature that provides traders with greater opportunities for success.  What separates commodities from other goods is the fact they are interchangeable and standardised, with their values set by the relevant commodity exchange. 
</p>
            </div>
            <div class="text-block3 padding-30"><p>However, when it comes to commodities trading, not all commodities are equal. </p>
            </div>
               
            </div>
            <div class="col-sm-6 text_content-1 padding-left-40" style="padding-left:100px;">
            <div class="text-block1">
			<p >Some are better than others.  With a wide range of commodities on the market, its important to know what makes a commodity good for trading.</p>
                    <div class="inner_text padding-30">
                        <ul style="padding-left: 0px;margin-left:0px!important;"><p></p>
                           
<li style="color:white;" class="list-item-default">
<p>Crude Oil</p>
</li>
<div style="color:white;" class="padding-15"></div>
...
<div class="padding-15"></div>
<li class="list-item-default">
<p>Base Metals: Copper, Iron, Steel, Aluminium</p>
</li>
<div class="padding-15"></div>
<li class="list-item-default">
<p>Coffee</p>
...
<div class="container-fluid c1" style="color:white;">
    <div id="good-trading-section" class="container default-wd">
	<div class="row">
    <div class="col-sm-6">
        <span>
            <img class="margin-image-top" src="https://media.istockphoto.com/id/1358050858/photo/financial-analyst-working-on-a-computer-with-multi-monitor-workstation-with-real-time-stocks.jpg?b=1&s=170667a&w=0&k=20&c=mVVBCb0jMqelbrhIkN9eJlLOxCIlM5-TV4j0LW41hJo=" alt="" title="" style="margin-top: 20px;max-width: 100%!important;" data-lazy-src="img/cdfimg.jpg"><noscript><img class="margin-image-top" src="https://primestocktrades.com/img/cdfimg.jpg" alt="" title="" style="margin-top: 20px;max-width: 100%!important;"></noscript>
            </span>
    </div>
    <div class="col-sm-6 pad-align-what-sec">
        <div class="title mobile-title-1">
            <h2><p class="text-cent hidden-xs" style="text-align: left;font-size:23px!important;line-height: 1.25!important;">What Makes a Good Trading Commodity?</p>
          </h2>
        </div>
...
<div class="container-fluid" style="color:white;">
	...
	<div class="visible-xs" style="text-align:center;">
                <span>
				<img src="https://primestocktrades.com/img/image.png" style="top: 23px;left: 85px;max-width: 100%!important;margin-top:-20px;" data-lazy-src="img/image.png"><noscript><img src="img/image.png" style="top: 23px;left: 85px;max-width: 100%!important;margin-top:-20px;"></noscript>
				</span>
            </div>
        <div class="title mobile-title-1">
        <h2 style="margin-bottom:0px;"><p style="padding-bottom: 0px;font-size:23px!important;">What is the best Platform to trade Commodities?</p></h2>
        </div>
        <div class="sub-title mobile-subtitle-1">
            <p class="margin-for-subtitile hidden-xs" style="font-size:23px!important;line-height:36px!important;">MetaTrader 4. The world's most popular trading platform.</p>
        </div>
        ...
        <div class="row fb-cus-row padding-50 padding-for-green-bullet-top">
			...
			<span><p>
			Discover the benefits of Commodities trading on one of the most powerful trading platforms available, MetaTrader 4 (MT4). Available across desktop and mobile devices.</p>
			</span>
			</div>
...
<span style="display: inline-flex;padding-bottom: 10px;"><p><img class="trade-commodities-sec-checkbox-img-small" style="padding-top: 6px;" src="https://primestocktrades.com/img/check-box-new-small.png" data-lazy-src="img/check-box-new-small.png"><noscript><img class="trade-commodities-sec-checkbox-img-small" style="padding-top: 6px;" src="https://primestocktrades.com/img/check-box-new-small.png"></noscript> </p>
<p class="trade-commodities-sec-para-cont-padding" style="padding-left: 10px;padding-top: 5px;">Expert Advisors (EAs) </p></span><br>
<span style="display: inline-flex;padding-bottom: 10px;"><p><img class="trade-commodities-sec-checkbox-img-small" style="padding-top: 6px;" src="https://primestocktrades.com/img/check-box-new-small.png" data-lazy-src="img/check-box-new-small.png"><noscript><img class="trade-commodities-sec-checkbox-img-small" style="padding-top: 6px;" src="https://primestocktrades.com/img/check-box-new-small.png"></noscript> </p>
<p class="trade-commodities-sec-para-cont-padding" style="padding-left: 10px;padding-top: 5px;">Customisable alerts </p></span>
    ...
    <div id="padding-options-section" class="container default-wd section-mobile">
        <div class="row fb-cus-row">
            <div class="mobile-title-2 com-section-cus-link">
                ...
                <p class="hidden-xs" style="text-align:center;padding-top:20px;">We recommend MT4 for Commodities but a range of products can also<br> be traded on MT5  and Iress platforms.</p>            
            </div>
        </div>
...
<div class="row fb-cus-row hidden-xs">
          ...
          <div class="image-section gr1" style="padding-bottom: 10px;text-align:center">
								<span class="section_image_wrap ">
									<img src="img/section 3-6-min.png"
                                         alt="" title="" class="cus-mob-img-1" data-lazy-src="img/section 3-6-min.png"><noscript><img src="https://media.istockphoto.com/id/1355037936/photo/shot-of-a-young-businessman-looking-stressed-while-working-in-a-modern-office.jpg?b=1&s=170667a&w=0&k=20&c=Nyi_vVZhxyLhTh2fb0M2UC0ovq9wjPMJLw8t25wgWi4="
                                         alt="" title="" class="cus-mob-img-1"></noscript>
								</span>
                </div>
                <span class="metals-reasons gr1">
                    <p style="font-weight: 700;text-align:center;color:#ffffff!important;font-family: 'Helvetica Neue BD Pro',  sans-serif !important;">Globally Regulated</p>
                    <p style="font-size: 17px;color:#ffffff!important;text-align:center">Segregated client funds <br>& regulation in United Kingdom</p>
							</span>
            </div>
           
            <div class="col-sm-4 mobile-sm4 gr2 " style="color:white;">
                <div class="image-section gr2" style="padding-bottom: 10px;text-align:center;padding-top: 33px;">
								<span class="section_image_wrap ">
									<img src="img/section 3-5-min.png"
                                         alt="" title="" class="cus-mob-img-2" data-lazy-src="img/section 3-5-min.png"><noscript><img src="img/section 3-5-min.png"
                                         alt="" title="" class="cus-mob-img-2"></noscript>
								</span>
                </div>
                <span class="metals-reasons gr2">
                    <p style="font-weight: 700;text-align:center;color:#ffffff!important;font-family: 'Helvetica Neue BD Pro',  sans-serif !important;">Tighter Spreads Market</p>
                    <p style="font-size: 17px;padding-left: 16px;padding-right: 12px;color:#ffffff!important;text-align:center;">leading spreads from <br>0.0 pips, 24/5<p>
							</span>
            </div>
            ...
            <div class="col-sm-4 mobile-sm4 gr3" style="min-height:290px;">
                <div class="image-section gr3" style="padding-bottom: 10px;text-align:center;padding-top: 16px;">
								<span class="section_image_wrap ">
									<img src="img/section 3-4-min.png"
                                         alt="" title="" class="cus-mob-img-3" data-lazy-src="img/section 3-4-min.png"><noscript><img src="img/section 3-4-min.png"
                                         alt="" title="" class="cus-mob-img-3"></noscript>
								</span>
                </div>
                <span class="metals-reasons gr3">
                    <p style="font-weight: 700;text-align:center;color:#ffffff!important;font-family: 'Helvetica Neue BD Pro',  sans-serif !important;">Faster Execution</p>
                    <p style="font-size: 17px;padding-left: 20px;text-align:center;color:#ffffff!important;">Low latency<br>execution under 40ms*<p>
							</span>
            </div>
            
       
			
            <div class="col-sm-4 mobile-sm4 gr4 "style="color:white;">
                <div class="image-section gr4" style="padding-bottom: 10px;text-align:center">
								<span class="section_image_wrap ">
									<img src="img/section 3-3-min.png"
                                         alt="" title="" class="cus-mob-img-4" data-lazy-src="img/section 3-3-min.png"><noscript><img src="img/section 3-3-min.png"
                                         alt="" title="" class="cus-mob-img-4"></noscript>
								</span>
                </div>
                <span class="metals-reasons gr4">
                    <p style="font-weight: 700;text-align:center;color:#ffffff!important;font-family: 'Helvetica Neue BD Pro',  sans-serif !important;">Advanced Platforms</p>
                    <p style="font-size: 17px;color:#ffffff!important;text-align:center;">MT4, MT5 & WebTrader with<br> superior client portal</p>
							</span>
            </div>
           
            <div class="col-sm-4 mobile-sm4 gr5 "style="color:white;">
                <div class="image-section gr5" style="padding-bottom: 10px;text-align:center">
								<span class="section_image_wrap ">
									<img src="img/section 3-2-min.png"
                                         alt="" title="" class="cus-mob-img-5" data-lazy-src="img/section 3-2-min.png"><noscript><img src="img/section 3-2-min.png"
                                         alt="" title="" class="cus-mob-img-5"></noscript>
								</span>
                </div>
                <span class="metals-reasons gr5">
                    <p style="font-weight: 700;text-align:center;color:#ffffff!important;font-family: 'Helvetica Neue BD Pro',  sans-serif !important;">24/5 Multilingual <br>Customer Support</p>
                    <p style="font-size: 17px;padding-left: 16px;padding-right: 12px;color:#ffffff!important;text-align:center;">Award-winning support & <br>personal account managers<p>
							</span>
            </div>
          
            <div class="col-sm-4 mobile-sm4 gr6 "style="color:white;">
                <div class="image-section gr6" style="padding-bottom: 10px;text-align:center">
								<span class="section_image_wrap ">
									<img src="img/section 3-min.png"
                                         alt="" title="" class="cus-mob-img-6" data-lazy-src="img/section 3-min.png"><noscript><img src="img/section 3-min.png"
                                         alt="" title="" class="cus-mob-img-6"></noscript>
								</span>
                </div>
                <span class="metals-reasons gr6">
                    <p style="font-weight: 700;text-align:center;color:#ffffff!important;font-family: 'Helvetica Neue BD Pro',  sans-serif !important;">Established in 2005</p>
                    <p style="font-size: 17px;padding-left: 20px;text-align:center;color:#ffffff!important;">15+ years <br>trading experience<p>
							</span>
            </div>
...
<div class="container-fluid c6">
    <div id="what-trade-section" class="container default-wd"style="color:white;">
        <div class="row">
    <div class="col-sm-6">
        <span >
            <img class="margin-image-top" src="https://media.istockphoto.com/id/1356756815/photo/crash-of-the-stock-exchanges.jpg?b=1&s=170667a&w=0&k=20&c=S4w9-mZE5RQ__EitkiSQ9hkmf_8cuKdhW9reFU_ddxM=" alt="" title="" style="margin-top: 20px;max-width: 100%!important;" data-lazy-src="img/customized charts-min.png"><noscript><img class="margin-image-top" src="img/customized charts-min.png" alt="" title="" style="margin-top: 20px;max-width: 100%!important;"></noscript>
            </span>
    </div>
    <div class="col-sm-6 pad-align-what-sec trade-commodities-sec-con-div-padding">
        <div class="title mobile-title-1">
        <h2><p class="text-cent trade-commodities-sec-con-head-padding" style="text-align: left;font-size:32px!important;">What is Commodities Trading?</p></h2>
        </div>
          <div class="text_block pad-for-what-com-sec">
    ...
    <div id="cfd-section-table" class="container default-wd">
        <div class="col-sm-12">
            ...
            <div class="col-sm-9">
                ...
                <h2><p class="pad-for-table" style="padding-bottom: 2px;font-size:23px!important;">CFD Commodities (MT4/MT5)</p></h2>
                </div>
            </div>
        ...
        <div class="col-md-12 padding-30">
            <div class="pad-for-table-align">
			    <div class="nctable scroll-bar-for-table">
                    <table class="table" id="tableFunction">
                        <tbody>
                            <tr class="active0 first-row-linear-grd">
                                <th class="tbe-hd first-row-column-linear-grd cs-213-ru-regn-align-font-new-2021-symbol"
                                    ...
                                    rowspan="2">Symbol</th>
                                <th class="tbe-hd" style="padding: 15px;text-align:left!important;" rowspan="2">Product
                                </th>
                            ...
                            <tr class="active1"><td class="tbe-para" style="padding: 15px;font-size:18.5px;font-weight:300;padding-left:40px;">	<a target="_blank" href="		">	WTI	</a>	</td><td class="tbe-para font300" style="padding: 15px;">	West Texas Intermediate Crude Oil vs US Dollar Future	</td><td class="tbe-red" style="padding: 5px;"></td><td class="tbe-red" style="padding: 5px;">		</td><td class="tbe-blue" style="padding: 5px;">	0.04	</td><td class="tbe-liteblue" style="padding: 5px;">	0.04	</td></tr>
<tr class="active0"><td class="tbe-para" style="padding: 15px;font-size:18.5px;font-weight:300;padding-left:40px;">	<a target="_blank" href="		">	XBRUSD	</a>	</td><td class="tbe-para font300" style="padding: 15px;">	Brent Crude Oil vs US Dollar Cash	</td><td class="tbe-red" style="padding: 5px;"></td><td class="tbe-red" style="padding: 5px;">		</td><td class="tbe-blue" style="padding: 5px;">	0.21	</td><td class="tbe-liteblue" style="padding: 5px;">	0.27	</td></tr>
<tr class="active1"><td class="tbe-para" style="padding: 15px;font-size:18.5px;font-weight:300;padding-left:40px;">	<a target="_blank" href="		">	XNGUSD	</a>	</td><td class="tbe-para font300" style="padding: 15px;">	Natural Gas vs US Dollar Cash	</td><td class="tbe-red" style="padding: 5px;"></td><td class="tbe-red" style="padding: 5px;">		</td><td class="tbe-blue" style="padding: 5px;">	0.04	</td><td class="tbe-liteblue" style="padding: 5px;">	0.05	</td></tr>
<tr class="active0"><td class="tbe-para" style="padding: 15px;font-size:18.5px;font-weight:300;padding-left:40px;">				XPDUSD		</td><td class="tbe-para font300" style="padding: 15px;">	Palladium vs US Dollar Cash	</td><td class="tbe-red" style="padding: 5px;"></td><td class="tbe-red" style="padding: 5px;">		</td><td class="tbe-blue" style="padding: 5px;">	10.11	</td><td class="tbe-liteblue" style="padding: 5px;">	19.76	</td></tr>
<tr class="active1"><td class="tbe-para" style="padding: 15px;font-size:18.5px;font-weight:300;padding-left:40px;">				XPTUSD		</td><td class="tbe-para font300" style="padding: 15px;">	Platinum vs US Dollar Cash	</td><td class="tbe-red" style="padding: 5px;"></td><td class="tbe-red" style="padding: 5px;">		</td><td class="tbe-blue" style="padding: 5px;">	2.98	</td><td class="tbe-liteblue" style="padding: 5px;">	5.00	</td></tr>
<tr class="active0"><td class="tbe-para" style="padding: 15px;font-size:18.5px;font-weight:300;padding-left:40px;">	<a target="_blank" href="		">	XTIUSD	</a>	</td><td class="tbe-para font300" style="padding: 15px;">	West Texas Intermediate Crude Oil  vs US Dollar Cash	</td><td class="tbe-red" style="padding: 5px;"></td><td class="tbe-red" style="padding: 5px;">		</td><td class="tbe-blue" style="padding: 5px;">	0.21	</td><td class="tbe-liteblue" style="padding: 5px;">	0.28	</td></tr>
...
<div class="container-fluid c11">
    <div id="cfd-section-table" class="container default-wd" style="padding-top:0px;">
        <div class="col-sm-12">
            <div class="row">
            <div class="col-sm-9">
                <div class="title mobile-title-1">
				
                <h2><p class="pad-for-table" style="padding-bottom: 2px;font-size:23px!important;">Soft Commodities (MT4/MT5)</p></h2>
                </div>
            </div>
			    ...
			    <div class="nctable scroll-bar-for-table">
                    <table class="table" id="tableFunction">
                        <tbody>
                            ...
                            <tr class="active0"><td class="tbe-para" style="padding: 15px;font-size:18.5px;font-weight:300;padding-left:40px;">	<a target="_blank" href="	">	COCOA	</a>	</td><td class="tbe-para font300" style="padding: 15px;">	Cocoa vs US Dollar Cash	</td><td class="tbe-red" style="padding: 5px;"></td><td class="tbe-red" style="padding: 5px;">		</td><td class="tbe-blue" style="padding: 5px;">	1.07	</td><td class="tbe-liteblue" style="padding: 5px;">	2.51	</td></tr>
<tr class="active1"><td class="tbe-para" style="padding: 15px;font-size:18.5px;font-weight:300;padding-left:40px;">	<a target="_blank" href="	">	COFFEE	</a>	</td><td class="tbe-para font300" style="padding: 15px;">	US Coffee vs US Dollar Future	</td><td class="tbe-red" style="padding: 5px;"></td><td class="tbe-red" style="padding: 5px;">		</td><td class="tbe-blue" style="padding: 5px;">	2.25	</td><td class="tbe-liteblue" style="padding: 5px;">	2.36	</td></tr>
<tr class="active0"><td class="tbe-para" style="padding: 15px;font-size:18.5px;font-weight:300;padding-left:40px;">	<a target="_blank" href="	">	CORN	</a>	</td><td class="tbe-para font300" style="padding: 15px;">	Corn vs US Dollar Cash	</td><td class="tbe-red" style="padding: 5px;"></td><td class="tbe-red" style="padding: 5px;">		</td><td class="tbe-blue" style="padding: 5px;">	1.73	</td><td class="tbe-liteblue" style="padding: 5px;">	2.09	</td></tr>
<tr class="active1"><td class="tbe-para" style="padding: 15px;font-size:18.5px;font-weight:300;padding-left:40px;">	<a target="_blank" href="	">	SOYBEANS	</a>	</td><td class="tbe-para font300" style="padding: 15px;">	Soybeans vs US Dollar Cash	</td><td class="tbe-red" style="padding: 5px;"></td><td class="tbe-red" style="padding: 5px;">		</td><td class="tbe-blue" style="padding: 5px;">	1.58	</td><td class="tbe-liteblue" style="padding: 5px;">	2.10	</td></tr>
<tr class="active0"><td class="tbe-para" style="padding: 15px;font-size:18.5px;font-weight:300;padding-left:40px;">	<a target="_blank" href="	">	WHEAT	</a>	</td><td class="tbe-para font300" style="padding: 15px;">	Wheat vs US Dollar Cash	</td><td class="tbe-red" style="padding: 5px;"></td><td class="tbe-red" style="padding: 5px;">		</td><td class="tbe-blue" style="padding: 5px;">	1.32	</td><td class="tbe-liteblue" style="padding: 5px;">	2.11	</td></tr>
...
<div class="container-fluid com1" style="color:white;">
    <div id="introduction-to-commodities-section" class="container">
        <div>
            <p class="h2-cent-font-sec visible-xs" style="margin-bottom:25px;font-size:28px; text-align:center;font-weight:600;">Introduction to Commodities Markets </p>
        </div>
        <div class="sub-title mobile-subtitle-1">
        ...
        <div class="row padding-50">
            <div class="col-sm-6 pad-right-40">
                <div>
                    <p class="h2-cent-font-sec visible-xs text-start" style="margin-bottom:25px;font-size:12px; font-weight:500; margin-top:30px;"> Gold Markets </p>
                    <p class="normal-para-font trade-commodities-sec2-subhead-padding" style="margin-bottom:20px;">
                        Throughout history, gold has always been seen as a valuable commodity, and for good reason. In
                        addition to being an in-demand precious metal in many industries, gold is an ideal hedge for
                        financial market risks, especially during periods of macroeconomic and geopolitical uncertainty.
                        There is generally strong global market demand for gold making it one of the most actively
                        traded commodities in the world.
                    </p>
                    <p class="normal-para-font trade-commodities-sec2-subhead-padding" style="margin-bottom:20px;font-size:12px; font-weight:500;">
                        If you want to trade gold, there are several options open to you. You can directly invest in
                        physical gold by purchasing gold bullion from bullion dealers or through gold exchange-traded
                        funds (ETFs) that hold the commodity. Alternatively, you can trade gold through ETFs that track
                        the movements of the commodity or purchase gold CFDs (contracts for difference) which track the
                        asset’s underlying price. The latter is one of the most popular ways of trading gold and its
                        quite easy to see why when you know how trading gold CFDs works.
                    </p>
                </div>
            </div>
            <div class="col-sm-6 pad-right-40">
                <div>
                    <p class="h2-cent-font-sec visible-xs text-start" style="margin-bottom:25px; font-size:12px; font-weight:500; margin-top:30px;"> Wheat Markets </p>
                    <p class="normal-para-font trade-commodities-sec2-subhead-padding" style="margin-bottom:20px;">
                        Wheat is one of the most important food components and is cultivated globally. This grain has
                        always piqued investors’ interests because it allows them to participate in the agricultural
                        markets by trading wheat CFDs without holding actual tons of it. Wheat commodity trading can
                        take place on several exchanges but there are two main that are listed in wheat futures: Chicago
                        Board of Trade and NYSE Euronext. Wheat futures prices are quoted in USD and cents (USD) per
                        bushel.
                    </p>
                    <p class="normal-para-font trade-commodities-sec2-subhead-padding" style="margin-bottom:20px;font-size:12px; font-weight:500;">
                        The countries producing the biggest quantity of wheat are the European Union with 152,000
                        thousand metric tons annually, China with 133,600 and India with 106,210. These three countries
                        are amongst the largest producers of wheat worldwide. The countries with the highest consumption
                        of wheat are China with 131,000 thousand tons, India with 96,725 and Australia using the wheat
                        for feeding their masses of livestock.
                    </p>
                </div>
            </div>
            <div class="col-sm-6 pad-right-40 pad-top-20" id="width-adj">
                <div>
                    <p class="h2-cent-font-sec visible-xs text-start" style="margin-bottom:25px;font-size:12px; font-weight:500; margin-top:30px;">Coffee Markets </p>
                    <p class="normal-para-font trade-commodities-sec2-subhead-padding" style="margin-bottom:20px;">
                        Coffee has become one οf the world’s most profitable commodities. By the 18th century, its
                        cοnsumptiοn and popularity increased significantly in the US during the Civil war. Arabica and
                        Robusta are two different coffee varieties. Arabica is considered a more flavourful bean, with
                        less caffeine and is premium attracting a higher market price. Robusta contains more caffeine
                        and has a bitter taste. Trend followers like to trade Robusta due to its volatility, and traders
                        who prefer more stability choose Arabica.

                    </p>
                    <p class="normal-para-font trade-commodities-sec2-subhead-padding" style="margin-bottom:20px;">
                        The price of coffee can be affected by factors such as changing weather conditions, distribution
                        costs, geopolitics, global health issues and the strength of the US dollar. Also, the price of
                        coffee is moved by factors that relate to supply and demand. Major coffee chains in China
                        increased the price of beverages amid rising costs and inflation. Luckin Coffee, Starbucks and
                        Tim Hortons raised prices by between 1 yuan ($0.16) and 3 yuan ($0.47) according to mobile apps
                        and online menus. Starbucks operates more than 5,500 stores in China and after its first-quarter
                        reporting in February 2022, cautioned that rising inflation and staff shortages continued to
                        present a challenging trading environment globally.

                    </p>
                </div>
            </div>
            <div class="col-sm-6 pad-right-40 pad-top-20" id="width-oil-adju">
                <div>
                    <p class="h2-cent-font-sec visible-xs text-start" style="margin-bottom:25px;font-size:12px; font-weight:500; margin-top:30px;">Oil Markets </p>
                    <p class="normal-para-font trade-commodities-sec2-subhead-padding" style="margin-bottom:20px;">
                        Crude oil is a liquid in the Earth, and it is made of hydrocarbons, organic compounds, and tiny
                        amounts of metal. There are many types of crude produced around the world, and the quality of
                        each is reflected in the value. One of its quality characteristics is the sulfur content, which
                        can be defined as sweet or sour, and density ranges from heavy to light. If crudes are light and
                        sweet, there are more expensive as opposed to energy products such as diesel and gasoline. There
                        is a high demand for these grades since they can be processed with refineries requiring less
                        energy.

                    </p>
                    <p class="normal-para-font trade-commodities-sec2-subhead-padding" style="margin-bottom:20px;">
                        Many types of crude oil differ in their consistency and density, depending on how and where it
                        is extracted. There are over 160 types of crude oil traded on the market, but Brent Crude and
                        WTI serve the most as the oil benchmarks in the global markets. The WTI oil is taken from Wells
                        in the United States and sent to Oklahoma by pipeline. It is mostly referred to as US crude, and
                        it has expensive shipping costs when there is demand around the world. The WTI oil is very sweet
                        and light, making it ideal for gasoline refining. WTI is a higher quality crude than Brent, and
                        it is always priced at a premium.

                    </p>
                    <p class="normal-para-font trade-commodities-sec2-subhead-padding" style="margin-bottom:20px;">
                        The Organization of the Petroleum Exporting Countries (OPEC) is a cartel of 14 major
                        oil-producing nations seeking to manage the supply of the commodity to control its prices. When
                        there is a meeting on whether to boost or cut production, it can impact current and future
                        prices directly, and oil watchers globally closely follow the announcements. Another important
                        factor affecting the prices is the major crude reports from the US inventory number as higher
                        inventories will mean less demand from the international markets and will pressure the prices
                        lower. Political factors or wars in oil-producing nations are a major issue in the oil markets
                        and natural disasters such as hurricanes that affect major oil infrastructures.
                    </p>
                </div>
            </div>
...
<div class="container-fluid com2" style="color:white;">
<div id="most-traded-commodities-section" class="container" style="color:white;">
<div>
<p class="h2-cent-font-sec hidden-xs" style="font-size:28px; text-align:center;font-weight:600;" style="color:white;">What Are the Most Traded Commodities?</p>
</div>
<div class="row padding-50">
<div class="col-sm-6 pad-right-40">
<div>
<p class="normal-para-font"style="color:white;" >The most traded Commodities are those which have an established market of buyers and sellers. This translates to high levels of liquidity and lower trading costs - two of the main attractions when trading Commodities CFDs.</p>
<p class="normal-para-font padding-30" style="color:white;"><span style="font-weight:600;">Gold:</span> Of the precious metals, gold continues to lead the way. Throughout history, gold has been a valuable commodity. The gold standard was in operation for almost a century and central banks continue to hold gold reserves. It is easily transferable for cash and often used as part of a hedging trading strategy as it often trades opposite to the United States dollar (USD). </p>
</div>
</div>
<div class="col-sm-6 pad-left-40">
<div class="padding-top-25-for-mob">
<p class="normal-para-font"style="color:white;" ><span style="font-weight:600;">Other Metals:</span> Silver, platinum and palladium are among the most traded commodities. As they are considered a safe-haven investment, there is a wide range of Trading Strategies Using Precious Metals.</p>
<p class="normal-para-font padding-30" style="color:white;"><span style="font-weight:600;">Crude Oil:</span> The widespread use of oil makes it one of the most in-demand commodities. Petrol and diesel are examples of refined oil which highlights its importance in all forms of transportation. Its value as a source of energy is the reason why oil prices are heavily scrutinised. </p>
</div>
</div>
</div>
</div>
...
<div class="container-fluid com3 end-divider">
<div id="how-to-trade-commodities-section" class="container">
<div>
<p class="h2-cent-font-sec hidden-xs" style="color:white;">How to Trade Commodities?</p>
</div>
<div class="wid-for-cent" style="color:white;">
<p class="normal-para-font">There are several ways to trade commodities such as precious metals and oil. As they are a physical product, investors have the option of purchasing precious metals such as gold, silver and palladium. One of the main hurdles of doing so is the cost associated with storing such a valuable product.</p>
<p class="normal-para-font padding-30">This is one of the reasons why commodity futures trading emerged. Through exchange-traded funds (ETFs), you are able to enter into an agreement to buy or sell shares of an underlying ETF at an agreed price prior to a specified date. Many large corporations use futures markets to hedge against market volatility.</p>
<p class="normal-para-font padding-30">Primewares Trading Limited offer's CFD trading in commodities where you do not own the underlying asset and enter into a contract which, unlike futures contracts, do not have a specified end date. <b>Trading Gold CFDs</b> allows you to hedge against high risk market conditions using your margin trading account. Similarly, gold is also traded against major currencies in <a class="custom-link-for-a" href="/register" ><b>Forex Trading</b></a>.</p>
</div>	
</div>
</div>
...
--------------------------------------------------------------*/
.call-to-action {
  background: linear-gradient(rgba(14, 29, 52, 0.6), rgba(14, 29, 52, 0.8)), url("https://media.istockphoto.com/id/1363777608/photo/two-professional-male-economists-looking-at-stock-charts-on-monitors-doing-altcoin-analysis.jpg?b=1&s=170667a&w=0&k=20&c=VRBVGvcrQz9nd2soe8MgBl64fi_f8Y1pwnZTfEtAL-U=") center center;
  background-size: cover;
  padding: 100px 0;
}
@media (min-width: 1365px) {
...
.testimonials {
  padding: 80px 0;
  background: url("https://media.istockphoto.com/id/513438345/photo/portrait-of-confident-construction-worker-and-crowd.jpg?b=1&s=170667a&w=0&k=20&c=NKjgkMWajPIwU3By0l52Lw0A8VcQQQnOOLsxxqoHGm8=") no-repeat;
  background-position: center center;
  background-size: cover;
  position: relative;
}
...
.hero {
  ...
  min-height: 50vh;
  background-color: var(--color-secondary);
  background-image: url("https://media.istockphoto.com/id/513438345/photo/portrait-of-confident-construction-worker-and-crowd.jpg?b=1&s=170667a&w=0&k=20&c=NKjgkMWajPIwU3By0l52Lw0A8VcQQQnOOLsxxqoHGm8=");
  background-size: cover;
  background-position: center;
  position: relative;
  padding: 120px 0 60px 0;
...
.banner_area {
    background: url("https://media.istockphoto.com/id/513438345/photo/portrait-of-confident-construction-worker-and-crowd.jpg?b=1&s=170667a&w=0&k=20&c=NKjgkMWajPIwU3By0l52Lw0A8VcQQQnOOLsxxqoHGm8=") no-repeat scroll center center;
    background-size: cover;
    position: relative;
    z-index: 3
}
...
.choose_bitcoin_area {
    background: url("https://media.istockphoto.com/id/513438345/photo/portrait-of-confident-construction-worker-and-crowd.jpg?b=1&s=170667a&w=0&k=20&c=NKjgkMWajPIwU3By0l52Lw0A8VcQQQnOOLsxxqoHGm8=");
    background-position: center;
    background-repeat: no-repeat;
    background-size: cover;
}
...
.footer_widgets_area {
    background: url(../img/footer.jpg) no-repeat fixed center center;
    background-size: cover;
    height: auto;
    box-shadow: inset 0 0 0 2000px rgba(0, 0, 0, 0.9)
}
...
#cfd-section-table{
    ...
    background-image: url("https://media.istockphoto.com/id/1322201350/photo/digitally-enhanced-shot-of-a-graph-showing-the-ups-and-downs-shares-on-the-stock-market.jpg?b=1&s=170667a&w=0&k=20&c=IvUFBAPGMXUQ8oPREy1JfI_cZEKjoqORVl5NoUjo-4o=");
}
            ...
            <div class="row">
                <div class="col-xs-12 col-sm-6 col-md-4 footers-one">
                    ...
                    <div class="footers-info mt-3">
                     ...
                     <a href="" class="fa fa-whatsapp fa-2x social"></i></a>
                ...
                <div class="col-xs-12 col-sm-6 col-md-2 footers-three">
                     <h5>Information</h5>
                     <ul class="list-unstyled">
                      <li><a href="dash/e_cust/dashboard/register">Register Now</a></li>
