                        ...
                        <div class="dt-header__toolbar">
                            ...
                            <div class="search-box d-none d-lg-block">
                                                            ...
                                                            <strong class="btn btn-primary">
                                                                primewaretrades welcomes you,   {{ Auth::user()->name }}
                                                            </strong>
                    ...
                    <aside id="main-sidebar" class="dt-sidebar ps ps--active-y">
                            ...
                            <ul class="dt-side-nav">
                                    ...
                                    <a href="/home"
                                        ...
                                        title="Dashboard">
                                      <img style="width:20px;margin-right:.5rem;" src="https://imgs.search.brave.com/cyChuuqyfU4MYX6FCnv-1gj6BsTfW9uI33_fYDQH930/rs:fit:474:225:1/g:ce/aHR0cHM6Ly90c2Ux/Lm1tLmJpbmcubmV0/L3RoP2lkPU9JUC5G/dkN6OXAwRDhGWkx6/cDNBbGRlTTF3SGFI/YSZwaWQ9QXBp">
                                ...
                                <li
                                    ...
                                    <a href="javascript:void(0)" class="dt-side-nav__link dt-side-nav__arrow"
                                        title="Dashboard">
                                         <img style="width:20px;margin-right:.5rem;" src="https://imgs.search.brave.com/y9kp6rymU_tDPiWqq_BZ8lSPzjbzd0Tx3Pe6V2nMt5E/rs:fit:474:225:1/g:ce/aHR0cHM6Ly90c2Uy/Lm1tLmJpbmcubmV0/L3RoP2lkPU9JUC5r/SVJ6cEwwSWVZR2U5/LTZRQ3pQU2R3SGFI/YSZwaWQ9QXBp">
                                        <span
                                ...
                                <li
                                    ...
                                    <a href="#" class="dt-side-nav__link dt-side-nav__arrow"
                                        title="Dashboard">
                                     <img style="width:20px;margin-right:.5rem;" src="https://imgs.search.brave.com/Vjy1AkxfrAiT51aaZzhjYmK1PCbwClf4xI5KxYRREi0/rs:fit:523:225:1/g:ce/aHR0cHM6Ly90c2U0/Lm1tLmJpbmcubmV0/L3RoP2lkPU9JUC5u/SzlCbjlLY3NrNVRu/TXRUV0M5VE53SGFH/dCZwaWQ9QXBp">
                                        <span
                  ...
                  @endif
                                <li
                                    ...
                                    <a href="/earn"
                                        class="dt-side-nav__link "
                                        title="Earnings">
                                       <img style="width:20px;margin-right:.5rem;" src="https://imgs.search.brave.com/2sc-an-SwsdcTAhwHlHj2ss3JHkxM0huIknAfqMt0-Y/rs:fit:439:225:1/g:ce/aHR0cHM6Ly90c2Uy/Lm1tLmJpbmcubmV0/L3RoP2lkPU9JUC5Z/cjBENVFDN21sMzlE/bEoxYktWd3l3SGFI/XyZwaWQ9QXBp">
                                ...
                                <li
                                    ...
                                    <a href="/transfer"
                                        class="dt-side-nav__link "
                                        title="Earnings">
                                       <img style="width:20px;margin-right:.5rem;color:red;" src="https://imgs.search.brave.com/2sc-an-SwsdcTAhwHlHj2ss3JHkxM0huIknAfqMt0-Y/rs:fit:439:225:1/g:ce/aHR0cHM6Ly90c2Uy/Lm1tLmJpbmcubmV0/L3RoP2lkPU9JUC5Z/cjBENVFDN21sMzlE/bEoxYktWd3l3SGFI/XyZwaWQ9QXBp">
                                        <span class="dt-side-nav__text" style="color:red;">Transfer Funds</span>
                                    </a>
                                </li>
                                 ...
                                 <li
                                    ...
                                    <a href="/ref"
                                        class="dt-side-nav__link "
                                        title="My Referrals">
                                      <img style="width:20px;margin-right:.5rem;" src="https://imgs.search.brave.com/Ss4UPeX_0RsUiSdk2Cl9__87hDbz5IT6Y1nXVcbV_mA/rs:fit:450:225:1/g:ce/aHR0cHM6Ly90c2Ux/Lm1tLmJpbmcubmV0/L3RoP2lkPU9JUC5V/VWNCVURldk53RWEx/Q01DYk9PMGxnSGFI/eiZwaWQ9QXBp">
                                ...
                                <li
                                    ...
                                    <a href="/help" class="dt-side-nav__link"
                                        title="Support">
                                        <img style="width:20px;margin-right:.5rem;" src="https://imgs.search.brave.com/mJkeM8wejllHh95JsJ00j1wVyuFgXst-hI-2JohbzCs/rs:fit:475:225:1/g:ce/aHR0cHM6Ly90c2U0/Lm1tLmJpbmcubmV0/L3RoP2lkPU9JUC5f/b0dEakl3YzcxZDE3/eXZHMlplenpnSGFI/WiZwaWQ9QXBp">
                                 ...
                                 <li
                                    ...
                                    <a href="/message" class="dt-side-nav__link"
                                        title="Support">
                                       <img style="width:20px;margin-right:.5rem;" src="https://imgs.search.brave.com/QIEgfc3e-jpnYEnujmKNV2_B5cgTGDuYwdjZB_SNalg/rs:fit:474:225:1/g:ce/aHR0cHM6Ly90c2Ux/Lm1tLmJpbmcubmV0/L3RoP2lkPU9JUC5i/MEIxZE1reGpRODVV/YzZPWUJFcldnSGFI/YSZwaWQ9QXBp">
            ...
            <div class="col-xl-12 col-12 col-md-12">
             ...
             <div class="col-md-6 col-sm-12 col-12">
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <div class="dt-card">
                            ...
                            <div class="dt-card__body p-xl-8 py-sm-8 py-6 px-4 dt-card bg-secondary text-white">
                                <span class="badge badge-secondary badge-top-right">Active Deposit</span>
                                <!-- Media -->
                                <div class="media">
                                    <img style="width:40px; margin-right:1rem;" src="https://imgs.search.brave.com/94bz_X1cysSDhAeFrm-ntWwZ0YeRiSZS6LAu8syk6CE/rs:fit:474:225:1/g:ce/aHR0cHM6Ly90c2U0/Lm1tLmJpbmcubmV0/L3RoP2lkPU9JUC5G/amdxa3UxaE1tTUVI/S0RDeDcwa093SGFI/YSZwaWQ9QXBp">
                                    <!-- Media Body -->
                                    <div class="media-body">
                                        <p class="mb-1 h1 text-white">
                                          ...
                                          <span class="d-block">Active Deposits</span>   
                                            
                                     @if (count($deposits)>0)
                                       <p style="font-weight:bolder;" class="mb-1 h1 text-light">
                    ...
                    <div class="col-md-6">
                        <!-- Card -->
                        <div class="dt-card" style="    background-color:rgb(1, 1, 15)";>
                            <!-- Card Body -->
                            <div class="dt-card__body p-xl-8 py-sm-8 py-6 px-4 dt-card bg-primary text-white" style="    background-color:rgb(1, 1, 15)";>
                                ...
                                <div class="media">
                                   <img style="width:40px; margin-right:1rem;" src="https://imgs.search.brave.com/94bz_X1cysSDhAeFrm-ntWwZ0YeRiSZS6LAu8syk6CE/rs:fit:474:225:1/g:ce/aHR0cHM6Ly90c2U0/Lm1tLmJpbmcubmV0/L3RoP2lkPU9JUC5G/amdxa3UxaE1tTUVI/S0RDeDcwa093SGFI/YSZwaWQ9QXBp">
                                    ...
                                    <div class="media-body" >
                                        <p class="mb-1 h1 text-white">
                                             <span class="d-block">Profit Bal(withdrawable) </span>
            ...
            <div class="col-md-5 col-sm-6 col-12">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div style="    background-color:rgb(1, 1, 15)";
                            class="dt-card dt-card bg-image-v6 bg-overlay overlay-opacity-0_8 bg-gradient-blue--after text-white">

                            <!-- Overlay Content -->
                            <div class="bg-overlay__inner mt-auto" style="    background-color:rgb(1, 1, 15)";>

                                <!-- Card Body -->
                                <div class="dt-card__body" style="    background-color:rgb(1, 1, 15)";>
                                ...
                                <p>Referral code   {{$user->refferal_code}}: 
                                    ...
                                    <form action="" id="joinForm"
                                        ...
                                        <form accept-charset="utf-8">
                                                                 <input type="hidden" name="csrf_test_name" value="d9a71a0de7594654f04c8a12e665f49a" />
                                        <input class="btn btn-outline-light btn-block" name="email"
                                            placeholder="Enter Email Address">
                                        <button type="submit" id="invite" class="btn btn-block">Invite friends</button>
                                        </form>
                                </div>
                                <!-- /card body -->
                    ...
                    <div class="col-md-12">
                        <div class="dt-card">
                            ...
                            <div class="dt-card__header mb-4">
                                ...
                                <!-- Card Heading -->
                                <div class="dt-card__heading">
                                    <h3 class="dt-card__title text-capitalize">Recent Deposits</h3>
                                </div>
                                <!-- /card heading -->

                                <!-- Card Tools -->
                                <div class="dt-card__tools">
                                    <a href="" class="dt-card__more">Total :	$	{{ DB::table('deposits')->where('user_id',$user->id)->sum('amount') }} </a>
                                </div>
                                <!-- /card tools -->
                                ...
                                <div class="table-responsive ps-custom-scrollbar ps">
                                    ...
                                    <table class="table table-ordered table-bordered-0 mb-0 ml-2">
                                        ...
                                        <tbody>
                                                ...
                                                <td>${{$depo->amount}}</td>
                                                <td> {{$depo->created_at->diffInHours()}} hours ago                                               </td>
