...
<head>
    ...
    <title>Primewaretrades Trading Limited | Pricing</title>
        ...
        <div class="row">
          <div class="col-md-6 d-flex align-items-stretch" data-aos="fade-up">
            <div class="card">
              ...
              <div class="card-body">
                <h5 class="card-title"><a href="/forex_price">Crypto Currency</a></h5>
                <p class="card-text">Cryptocurrency, sometimes called crypto-currency or crypto, is any form of currency that exists digitally or virtually and uses cryptography to secure transactions. Cryptocurrencies don't have a central issuing or regulating authority, instead using a decentralized system to record transactions and issue new units..</p>
          ...
          <div class="col-md-6 d-flex align-items-stretch" data-aos="fade-up">
            <div class="card">
              ...
              <div class="card-body">
                <h5 class="card-title"><a href="/oil">Oil And Gas</a></h5>
                <p class="card-text">Oil and natural gas are major industries in the energy market and play an influential role in the global economy as the world's primary fuel sources. The processes and systems involved in producing and distributing oil and gas are highly complex, capital-intensive, and require state-of-the-art technology. Historically, natural gas has been linked to oil, mainly because of the production process or upstream side of the business. For much of the history of the industry, natural gas was viewed as a nuisance and even today is flared in large quantities in some parts of the world, including the United States</p>
                <div class="read-more"><button class="btn-btn-primary" ><a href="/oil"><i class="bi bi-arrow-right"></i> View Pricing</a></button></div>
              </div>
            </div>
          ...
          <div class="col-md-6 d-flex align-items-stretch" data-aos="fade-up">
            <div class="card">
              ...
              <div class="card-body">
                <h5 class="card-title"><a href="/real">Real Estate Pricing</a></h5>
                <p class="card-text">Real estate is defined as the land and any permanent structures, like a home, or improvements attached to the land, whether natural or man-made.

Real estate is a form of real property. It differs from personal property, which is not permanently attached to the land, such as vehicles, boats, jewelry, furniture, and farm equipment..</p>
                <div class="read-more"><button class="btn-btn-primary" ><a href="/real"><i class="bi bi-arrow-right"></i>View Pricing</a></button></div>
              </div>
            </div>
          </div>
        </div>
