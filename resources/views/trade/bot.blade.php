...
#hero {
  width: 100%;
  height: 70vh;
  background: url("https://media.istockphoto.com/id/1160576467/photo/asian-businesswoman-presenting-her-ideas-for-company-development.jpg?s=612x612&w=0&k=20&c=VbpACwT9afysS7MZMCAk8mQckPDBsXkdsetsM-bO_pA=") top center;
  background-size: cover;
  position: relative;
  padding: 0;
}
...
@media (max-width: 768px) {
  ...
  <section id="hero">
    <div class="hero-container" data-aos="fade-up" data-aos-delay="150">
      ...
      <div class="d-flex">
        <a href="/register" class="btn-get-started scrollto">Start Trading</a>
      </div>
    </div>
  </section><!-- End Hero -->
      <br><br>
 ...
 <div class="container-fluid end-divider">
    <div id="section1" class="container default-wd mobile-padding-top1">
        <div class="title">
        <h2 style="padding-bottom:5px;">Trade Cryptocurrencies with Primewaretrades Trading Limited</h2>
        </div>
        ...
        <div class="row fb-cus-row">
            ...
            <div class="text-block1"><p>Trading cryptocurrency CFDs ("contracts for difference") is a great way to diversify your portfolio and hedge risks. Primewaretrades Trading Limited has carved a niche for itself in the 
              Crypto trading market in the United Kingdom, offering the optimal trading experience.</p>
            </div>
            <div class="text-block2 padding-30"><p>Choosing from an extensive portfolio of financial products, while benefiting from the latest real-time technology and the leverage available on 
              Crypto pairs BTCUSD, ETHUSD, LTCUSD and BCHUSD is now 1:200 for clients registered with Primewaretrades Trading Limited.</p>
            </div>
            <div class="text-block3 padding-30"><p> Unlike other asset classes (FX, Equities, Commodities, etc.), the Cryptocurrency market is dominated by retail speculators. 
              With IC Markets Cryptocurrency CFDs, youll trade in a market where there is no central bank intervention, interbank dealers controlling order flow or giant pension funds moving prices.</p>
            </div>
               
            </div>
            <div class="col-sm-6 text_content-1 padding-left-40" style="padding-left:40px;">
            <div class="text-block1"><p class="para-cent trade-commodities-cont-subhead-padding" style="font-size:23px!important;">What are the benefits of crypto trading?</p>
...
<div class="container-fluid">
    <div id="top-ten-section" class="container default-wd">
        <div class="title">
            <h2><p class="hidden-xs text-white" style="padding-bottom:5px;color:white;">The Top Ten Crypto Pairs to Trade</p>
			</h2>
        </div>
		...
		<div class="row fb-cus-row">
            ...
            <div class="text-block1"><p>When you trade cryptocurrencies with IG, you are speculating on whether your chosen market will rise or fall in value, without ever taking ownership of the digital asset. This is done by using derivative products such as CFDs.

 </p>
            </div>
            <div class="text-block2 padding-30"><p>Although the cryptocurrency market is relatively new, it has experienced significant volatility due to huge amounts of short-term speculative interest. For example, between October 2017 and October 2018, the price of bitcoin rose as high as $19,378 and fell to lows of $5851,<br> 
            ...
            <div class="text-block3 padding-30"><p>However, when it comes to digital currencies trading, not all currencies are tradable. </p>
            </div>
               
            </div>
            <div class="col-sm-6 text_content-1 padding-left-40" style="padding-left:100px;">
            <div class="text-block1">
			<p >Some are better than others.  With a wide range of currencies on the market, it’s important to know what makes a coin best for trading.</p>
...
<div class="container-fluid c1">
    ...
    <div class="col-sm-6 pad-align-what-sec">
        <div class="title mobile-title-1">
            <h2><p class="text-cent hidden-xs" style="text-align: left;font-size:28px!important;line-height: 1.25!important;">What Makes a Good<br>Trading Digital Currency?</p>
          </h2>
        </div>
          <div class="text_block pad-for-what-com-sec">
            <p>The market capitalization of all publicly traded cryptos plunged by 33% in that short period, falling from $1.31 trillion to $880 billion. That, in turn, is a 70% decline from the $2.96 trillion market cap in November 2021. Needless to say, this asset class isn't a playground for momentum investors at the moment, but contrarians may want to start considering small investments in some of the top cryptocurrencies at current levels, for a few reasons. </p>
        </div>
        <div class="text_block pad-for-what-com-sec padding-30">
            <p>First, digital assets are more established than they've ever been at any point in their history, and projects in the young industry continue to attract huge levels of brainpower, labor and investment.</p>
          <p>Second, 70% declines aren't actually unprecedented in crypto. Bitcoin fell from roughly $20,000 to about $3,000 between late 2017 and late 2018, for example</p>
        </div>
...
<div class="container-fluid">
	...
	<div class="visible-xs" style="text-align:center;">
        ...
        <div class="title mobile-title-1">
        <h2 style="margin-bottom:0px;"><p style="padding-bottom: 0px;font-size:32px!important;">What is the best Platform to trade Crypto Currencies?</p></h2>
        </div>
        ...
        <div class="row fb-cus-row padding-50 padding-for-green-bullet-top">
			...
			<span><p>
			Discover the benefits of Crypto Currency trading on one of the most powerful trading platforms available, MetaTrader 4 (MT4).</p>
			</span>
			</div>
                <div class="inner_text padding-default padding-for-green-bullet">
									<span style="display: inline-flex;padding-bottom: 10px;"><p><img class="trade-commodities-sec-checkbox-img-small" style="padding-top: 6px;" src="https://primestocktrades.com/img/check-box-new-small.png" data-lazy-src="https://media.istockphoto.com/id/1368105674/photo/investing-cryptocurrency-using-smart-phone-apps.jpg?s=612x612&w=0&k=20&c=nIIWySNkU6Nu55ExHbsoS7Jjgq4zF-lKIhLUZ9d5yyE="><noscript><img class="trade-commodities-sec-checkbox-img-small" style="padding-top: 6px;" src="img/check-box-new-small.png"></noscript> </p>
<p class="trade-commodities-sec-para-cont-padding" style="padding-left: 10px;padding-top: 5px;">Leverage shift in price</p></span><br>
<span style="display: inline-flex;padding-bottom: 10px;"><p><img class="trade-commodities-sec-checkbox-img-small" style="padding-top: 3px;" src="https://primestocktrades.com/img/check-box-new-small.png" data-lazy-src="img/check-box-new-small.png"><noscript><img class="trade-commodities-sec-checkbox-img-small" style="padding-top: 3px;" src="img/check-box-new-small.png"></noscript> </p>
...
<span style="display: inline-flex;padding-bottom: 10px;"><p><img class="trade-commodities-sec-checkbox-img-small" style="padding-top: 6px;max-width: none" src="https://primestocktrades.com/img/check-box-new-small.png" data-lazy-src="img/check-box-new-small.png"><noscript><img class="trade-commodities-sec-checkbox-img-small" style="padding-top: 6px;max-width: none" src="img/check-box-new-small.png"></noscript> </p>
...
<span style="display: inline-flex;padding-bottom: 10px;"><p><img class="trade-commodities-sec-checkbox-img-small" style="padding-top: 6px;" src="https://primestocktrades.com/img/check-box-new-small.png" data-lazy-src="img/check-box-new-small.png"><noscript><img class="trade-commodities-sec-checkbox-img-small" style="padding-top: 6px;" src="img/check-box-new-small.png"></noscript> </p>
<p class="trade-commodities-sec-para-cont-padding" style="padding-left: 10px;padding-top: 5px;">The option of going long or short </p></span>
    ...
    <div id="padding-options-section" class="container default-wd section-mobile">
        <div class="row fb-cus-row">
            <div class="mobile-title-2 com-section-cus-link">
                ...
                <p class="hidden-xs" style="text-align:center;padding-top:20px;">We recommend MT4 for Crypto Currencies but a range of products can also<br> be traded on MT5 platforms.</p>            
            </div>
        </div>
...
<div id="six-reason-section" class="container default-wd">
    ...
    <h2><p class="hidden-xs" style="color:#ffffff!important;padding-bottom: 10px;font-size: 32px !important;">6 Reasons to Choose Primewaretrades Trading Limited</p>
      </h2>
</div>
...
<div class="row fb-cus-row hidden-xs">
            ...
            <div class="col-sm-4 mobile-sm4 gr1">
                        <div class="image-section gr1" style="padding-bottom: 10px;text-align:center">
								<span class="section_image_wrap ">
									<img src="https://primestocktrades.com/img/section%203-6-min.png"
                                         alt="" title="" class="cus-mob-img-1" data-lazy-src="img/section 3-6-min.png"><noscript><img src="img/section 3-6-min.png"
            ...
            <div class="col-sm-4 mobile-sm4 gr2 ">
                <div class="image-section gr2" style="padding-bottom: 10px;text-align:center;padding-top: 33px;">
								<span class="section_image_wrap ">
									<img src="https://primestocktrades.com/img/section%203-5-min.png"
                                         alt="" title="" class="cus-mob-img-1" data-lazy-src="img/section 3-6-min.png"><noscript><img src="img/section 3-6-min.png"
                                         alt="" title="" class="cus-mob-img-1"></noscript>
								</span>
                </div>
            ...
            <div class="col-sm-4 mobile-sm4 gr3" style="min-height:290px;">
                <div class="image-section gr3" style="padding-bottom: 10px;text-align:center;padding-top: 16px;">
								<span class="section_image_wrap ">
									<img src="https://primestocktrades.com/img/section%203-4-min.png"
                                         alt="" title="" class="cus-mob-img-1" data-lazy-src="img/section 3-6-min.png"><noscript><img src="img/section 3-6-min.png"
                                         alt="" title="" class="cus-mob-img-1"></noscript>
								</span>
                </div>
            ...
            <div class="col-sm-4 mobile-sm4 gr4 ">
                <div class="image-section gr4" style="padding-bottom: 10px;text-align:center">
								<span class="section_image_wrap ">
									<img src="https://primestocktrades.com/img/section%203-3-min.png"
                                         alt="" title="" class="cus-mob-img-1" data-lazy-src="img/section 3-6-min.png"><noscript><img src="img/section 3-6-min.png"
                                         alt="" title="" class="cus-mob-img-1"></noscript>
								</span>
                </div>
            ...
            <div class="col-sm-4 mobile-sm4 gr5 ">
                <div class="image-section gr5" style="padding-bottom: 10px;text-align:center">
								<span class="section_image_wrap ">
									<img src="https://primestocktrades.com/img/section%203-2-min.png"
                                         alt="" title="" class="cus-mob-img-1" data-lazy-src="img/section 3-6-min.png"><noscript><img src="img/section 3-6-min.png"
                                         alt="" title="" class="cus-mob-img-1"></noscript>
								</span>
                </div>
                <span class="metals-reasons gr5">
                    ...
                    <p style="font-size: 17px;padding-left: 16px;padding-right: 12px;color:#ffffff!important;text-align:center;">Award-winning support & <br>account managers<p>
							</span>
            </div>
            ...
            <div class="col-sm-4 mobile-sm4 gr6 ">
                <div class="image-section gr6" style="padding-bottom: 10px;text-align:center">
								<span class="section_image_wrap ">
									<img src="https://primestocktrades.com/img/section%203-min.png"
                                         alt="" title="" class="cus-mob-img-1" data-lazy-src="img/section 3-6-min.png"><noscript><img src="img/section 3-6-min.png"
                                         alt="" title="" class="cus-mob-img-1"></noscript>
								</span>
                </div>
        ...
        <div class="col-sm-12">
            ...
            <div class="col-sm-9">
                <div class="title mobile-title-1">
                    ...
                    <h2><p class="pad-for-table" style="padding-bottom: 2px;font-size:32px!important;">Crypto CFD Spreads</p></h2>
                </div>
            </div>
            <div class="col-sm-3">
                <span>
<img class="searchbar-image-align" src="data:image/svg+xml,%3Csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%200%200'%3E%3C/svg%3E" alt="" title="" data-lazy-src="/wp-content/themes/fptheme/image-2020/metals/desktop/search-min.png"><noscript><img class="searchbar-image-align" src="/wp-content/themes/fptheme/image-2020/metals/desktop/search-min.png" alt="" title=""></noscript>
<input class="form-control bg-style-for-box cs10essearchw cs10visearchsym cs10frsearch cs10brsearch cs-pl-10-serc-box-al" onkeyup="tableFunction()" id="myInput" type="text" placeholder="Search by Symbol" style="width: 75%;border: 1px solid transparent!important;border-image-source: url(/wp-content/themes/fptheme/image-2020/metals/desktop/search-2-min.png)!important;border-image-slice: 16!important;border-image-width: 10px!important;">
...
function tableFunction() {
  ...
  <tr class="active0 first-row-linear-grd">
    <th class="tbe-hd first-row-column-linear-grd cs-213-ru-regn-align-font-new-2021-symbol"
      ...
      rowspan="2">Symbol</th>
    <th class="tbe-hd" style="padding: 15px;text-align:left!important;" rowspan="2">Product</th>
  ...
  <tr class="active0"><td class="tbe-para" style="padding: 15px;font-size:18.5px;font-weight:300;padding-left:40px;"><a target="_blank" href="	#">	BCHUSD	</a>	</td><td class="tbe-para font300" style="padding: 15px;">	Bitcoin Cash vs United States Dollar CFD	</td><td class="tbe-red" style="padding: 5px;"></td><td class="tbe-red" style="padding: 5px;">	2.210</td><td class="tbe-liteblue" style="padding: 5px;">	5.839	</td></tr>
<tr class="active1"><td class="tbe-para" style="padding: 15px;font-size:18.5px;font-weight:300;padding-left:40px;">	<a target="_blank" href="	#">	BTCUSD	</a>	</td><td class="tbe-para font300" style="padding: 15px;">	Bitcoin vs United States Dollar CFD	</td><td class="tbe-red" style="padding: 5px;"></td><td class="tbe-red" style="padding: 5px;">	8.710	</td><td class="tbe-liteblue" style="padding: 5px;">	42.036	</td></tr>
<tr class="active0"><td class="tbe-para" style="padding: 15px;font-size:18.5px;font-weight:300;padding-left:40px;">	<a target="_blank" href="	#">	DOTUSD	</a>	</td><td class="tbe-para font300" style="padding: 15px;">	Polkadot vs United States Dollar CFD	</td><td class="tbe-red" style="padding: 5px;"></td><td class="tbe-red" style="padding: 5px;">	0.011	</td><td class="tbe-liteblue" style="padding: 5px;">	0.013	</td></tr>
<tr class="active1"><td class="tbe-para" style="padding: 15px;font-size:18.5px;font-weight:300;padding-left:40px;">	<a target="_blank" href="	#">	DSHUSD	</a>	</td><td class="tbe-para font300" style="padding: 15px;">	Dash Coin vs United States Dollar CFD	</td><td class="tbe-red" style="padding: 5px;"></td><td class="tbe-red" style="padding: 5px;">	0.000	</td><td class="tbe-liteblue" style="padding: 5px;">	1.241	</td></tr>
<tr class="active0"><td class="tbe-para" style="padding: 15px;font-size:18.5px;font-weight:300;padding-left:40px;">	<a target="_blank" href="	#">	EOSUSD	</a>	</td><td class="tbe-para font300" style="padding: 15px;">	EOS vs United States Dollar CFD	</td><td class="tbe-red" style="padding: 5px;"></td><td class="tbe-red" style="padding: 5px;">	0.000	</td><td class="tbe-liteblue" style="padding: 5px;">	0.064	</td></tr>
<tr class="active1"><td class="tbe-para" style="padding: 15px;font-size:18.5px;font-weight:300;padding-left:40px;">	<a target="_blank" href="	#">	ETHUSD	</a>	</td><td class="tbe-para font300" style="padding: 15px;">	Ethereum vs United States Dollar CFD	</td><td class="tbe-red" style="padding: 5px;"></td><td class="tbe-red" style="padding: 5px;">	4.560	</td><td class="tbe-liteblue" style="padding: 5px;">	11.605	</td></tr>
<tr class="active0"><td class="tbe-para" style="padding: 15px;font-size:18.5px;font-weight:300;padding-left:40px;">	<a target="_blank" href="	#">	LNKUSD	</a>	</td><td class="tbe-para font300" style="padding: 15px;">	Chainlink vs United States Dollar CFD	</td><td class="tbe-red" style="padding: 5px;"></td><td class="tbe-red" style="padding: 5px;">	0.012	</td><td class="tbe-liteblue" style="padding: 5px;">	0.020	</td></tr>
<tr class="active1"><td class="tbe-para" style="padding: 15px;font-size:18.5px;font-weight:300;padding-left:40px;">	<a target="_blank" href="	#">	LTCUSD	</a>	</td><td class="tbe-para font300" style="padding: 15px;">	Lite Coin vs United States Dollar CFD	</td><td class="tbe-red" style="padding: 5px;"></td><td class="tbe-red" style="padding: 5px;">	1.050	</td><td class="tbe-liteblue" style="padding: 5px;">	1.597	</td></tr>
<tr class="active0"><td class="tbe-para" style="padding: 15px;font-size:18.5px;font-weight:300;padding-left:40px;">	<a target="_blank" href="	#">	NMCUSD	</a>	</td><td class="tbe-para font300" style="padding: 15px;">	NameCoin vs United States Dollar CFD	</td><td class="tbe-red" style="padding: 5px;"></td><td class="tbe-red" style="padding: 5px;">	7.895	</td><td class="tbe-liteblue" style="padding: 5px;">	7.895	</td></tr>
<tr class="active1"><td class="tbe-para" style="padding: 15px;font-size:18.5px;font-weight:300;padding-left:40px;">	<a target="_blank" href="	#">	XLMUSD	</a>	</td><td class="tbe-para font300" style="padding: 15px;">	Stellar vs United States Dollar CFD	</td><td class="tbe-red" style="padding: 5px;"></td><td class="tbe-red" style="padding: 5px;">	0.000	</td><td class="tbe-liteblue" style="padding: 5px;">	0.000	</td></tr>
<tr class="active0"><td class="tbe-para" style="padding: 15px;font-size:18.5px;font-weight:300;padding-left:40px;">	<a target="_blank" href="	#">	XRPUSD	</a>	</td><td class="tbe-para font300" style="padding: 15px;">	Ripple vs United States Dollar CFD	</td><td class="tbe-red" style="padding: 5px;"></td><td class="tbe-red" style="padding: 5px;">	0.008	</td><td class="tbe-liteblue" style="padding: 5px;">	0.020	</td></tr>
<tr class="active1"><td class="tbe-para" style="padding: 15px;font-size:18.5px;font-weight:300;padding-left:40px;">	<a target="_blank" href="	#">	ADAUSD	</a>	</td><td class="tbe-para font300" style="padding: 15px;">	Cardano vs United States Dollar CFD	</td><td class="tbe-red" style="padding: 5px;"></td><td class="tbe-red" style="padding: 5px;">	0.003	</td><td class="tbe-liteblue" style="padding: 5px;">	0.003	</td></tr>
<tr class="active1"><td class="tbe-para" style="padding: 15px;font-size:18.5px;font-weight:300;padding-left:40px;">	<a target="_blank" href="	#">	BNBUSD	</a>	</td><td class="tbe-para font300" style="padding: 15px;">	Binance Smartchain vs United States Dollar CFD	</td><td class="tbe-red" style="padding: 5px;"></td><td class="tbe-red" style="padding: 5px;">	1.266	</td><td class="tbe-liteblue" style="padding: 5px;">	1.415	</td></tr>
<tr class="active0"><td class="tbe-para" style="padding: 15px;font-size:18.5px;font-weight:300;padding-left:40px;">	<a target="_blank" href="	#">	DOGUSD	</a>	</td><td class="tbe-para font300" style="padding: 15px;">	Doge vs United States Dollar CFD	</td><td class="tbe-red" style="padding: 5px;"></td><td class="tbe-red" style="padding: 5px;">	0.001	</td><td class="tbe-liteblue" style="padding: 5px;">	0.001	</td></tr>
<tr class="active1"><td class="tbe-para" style="padding: 15px;font-size:18.5px;font-weight:300;padding-left:40px;">	<a target="_blank" href="	#">	BSVUSD	</a>	</td><td class="tbe-para font300" style="padding: 15px;">	Bitcoin SV vs United States Dollar CFD	</td><td class="tbe-red" style="padding: 5px;"></td><td class="tbe-red" style="padding: 5px;">	1.7	</td><td class="tbe-liteblue" style="padding: 5px;">	0.6	</td></tr>
...
.table>tbody>tr>th {
    ...
    line-height: .2!important; vertical-align: inherit!important;
}
.table>tbody>tr>td{
border-top:none!important;
}
...
.c5{
    ...
    background-image: url("https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTYG6xpqcB4qD58F5d1MTxtS5mlhlwMddEMGg&usqp=CAU");
}
    .c6 {
        background-color: #ffffff !important;
            ...
            <div class="row">
                <div class="col-xs-12 col-sm-6 col-md-4 footers-one">
                    ...
                    <div class="footers-info mt-3">
                         <p>"Primeware is not just a company, it's a mission"<br> - Michael Walker, Founder and CEO </p>
                     </div>
