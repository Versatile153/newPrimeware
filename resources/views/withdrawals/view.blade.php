...
.form-control:focus {
  ...
  border-color: #9679db;
  outline: 0;
  box-shadow: inset 0 1px 1px rgba(0, 0, 0, 0.075), 0 0 0 0 rgba(81, 45, 168, 0.25)
}
...
.was-validated .form-control:valid, .form-control.is-valid {
  ...
  background-position: center right calc(.35em + .53rem);
  background-size: calc(.7em + 1.06rem) calc(.7em + 1.06rem)
}
...
.was-validated textarea.form-control:valid, textarea.form-control.is-valid {
  padding-right: calc(1.4em + 2.12rem);
  background-position: top calc(.35em + .53rem) right calc(.35em + .53rem)
}
...
.was-validated .custom-select:invalid, .custom-select.is-invalid {
  border-color: #f44336;
  padding-right: calc((1em + .75rem) * 3 / 4 + 1.75rem);
  background: url("data:image/svg+xml,%3csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 4 5'%3e%3cpath fill='%23343a40' d='M2 0L0 2h4zm0 5L0 3h4z'/%3e%3c/svg%3e") no-repeat right 1.7rem center/8px 10px, url("data:image/svg+xml,%3csvg xmlns='http://www.w3.org/2000/svg' fill='%23dc3545' viewBox='-2 -2 7 7'%3e%3cpath stroke='%23dc3545' d='M0 0l3 3m0-3L0 3'/%3e%3ccircle r='.5'/%3e%3ccircle cx='3' r='.5'/%3e%3ccircle cy='3' r='.5'/%3e%3ccircle cx='3' cy='3' r='.5'/%3e%3c/svg%3E") #fff no-repeat center right 1.75rem/calc(.75em + .375rem) calc(.75em + .375rem)
}
...
.btn:not(:disabled):not(.disabled):active:focus, .btn:not(:disabled):not(.disabled).active:focus {
  box-shadow: 0 0 0 0 rgba(81, 45, 168, 0.25), inset 0 3px 5px rgba(0, 0, 0, 0.125)
}
...
.btn-primary:focus, .btn-primary.focus {
  box-shadow: inset 0 1px 0 rgba(255, 255, 255, 0.15), 0 1px 1px rgba(0, 0, 0, 0.075), 0 0 0 0 rgba(107, 77, 181, 0.5)
}
...
.btn-primary:not(:disabled):not(.disabled):active:focus, .btn-primary:not(:disabled):not(.disabled).active:focus, .show>.btn-primary.dropdown-toggle:focus {
  box-shadow: inset 0 3px 5px rgba(0, 0, 0, 0.125), 0 0 0 0 rgba(107, 77, 181, 0.5)
}
...
.btn-secondary:focus, .btn-secondary.focus {
  box-shadow: inset 0 1px 0 rgba(255, 255, 255, 0.15), 0 1px 1px rgba(0, 0, 0, 0.075), 0 0 0 0 rgba(255, 93, 148, 0.5)
}
...
.btn-secondary:not(:disabled):not(.disabled):active:focus, .btn-secondary:not(:disabled):not(.disabled).active:focus, .show>.btn-secondary.dropdown-toggle:focus {
  box-shadow: inset 0 3px 5px rgba(0, 0, 0, 0.125), 0 0 0 0 rgba(255, 93, 148, 0.5)
}
...
.btn-info {
  color: white;
  background: linear-gradient(to right top, #3043c0, #5f49cc, #8450d7, #a656e1, #c75cea)!important;
  border: white;
  border-radius: 100px;
  box-shadow: inset 0 1px 0 rgba(255, 255, 255, 0.15), 0 1px 1px rgba(0, 0, 0, 0.075);
}
...
.btn-danger:focus, .btn-danger.focus {
  box-shadow: inset 0 1px 0 rgba(255, 255, 255, 0.15), 0 1px 1px rgba(0, 0, 0, 0.075), 0 0 0 0 rgba(246, 95, 84, 0.5)
}
...
.btn-danger:not(:disabled):not(.disabled):active:focus, .btn-danger:not(:disabled):not(.disabled).active:focus, .show>.btn-danger.dropdown-toggle:focus {
  box-shadow: inset 0 3px 5px rgba(0, 0, 0, 0.125), 0 0 0 0 rgba(246, 95, 84, 0.5)
}
...
.btn-dark:focus, .btn-dark.focus {
  box-shadow: inset 0 1px 0 rgba(255, 255, 255, 0.15), 0 1px 1px rgba(0, 0, 0, 0.075), 0 0 0 0 rgba(66, 66, 66, 0.5)
}
...
.btn-dark:not(:disabled):not(.disabled):active:focus, .btn-dark:not(:disabled):not(.disabled).active:focus, .show>.btn-dark.dropdown-toggle:focus {
  box-shadow: inset 0 3px 5px rgba(0, 0, 0, 0.125), 0 0 0 0 rgba(66, 66, 66, 0.5)
}
...
.btn-outline-primary:not(:disabled):not(.disabled):active:focus, .btn-outline-primary:not(:disabled):not(.disabled).active:focus, .show>.btn-outline-primary.dropdown-toggle:focus {
  box-shadow: inset 0 3px 5px rgba(0, 0, 0, 0.125), 0 0 0 0 rgba(81, 45, 168, 0.5)
}
...
.btn-outline-secondary:not(:disabled):not(.disabled):active:focus, .btn-outline-secondary:not(:disabled):not(.disabled).active:focus, .show>.btn-outline-secondary.dropdown-toggle:focus {
  box-shadow: inset 0 3px 5px rgba(0, 0, 0, 0.125), 0 0 0 0 rgba(255, 64, 129, 0.5)
}
...
.custom-select:focus {
  border-color: #9679db;
  outline: 0;
  box-shadow: inset 0 1px 2px rgba(0, 0, 0, 0.075), 0 0 0 0 rgba(81, 45, 168, 0.25)
}
...
.card-footer:last-child {
  border-radius: 0 0 calc(.4rem - 0px) calc(.4rem - 0px)
}
...
.card-img {
  width: 100%;
  border-radius: calc(.4rem - 0px)
}

.card-img-top {
  width: 100%;
  border-top-left-radius: calc(.4rem - 0px);
  border-top-right-radius: calc(.4rem - 0px)
}

.card-img-bottom {
  width: 100%;
  border-bottom-right-radius: calc(.4rem - 0px);
...
a.badge-primary:focus, a.badge-primary.focus {
  outline: 0;
  box-shadow: 0 0 0 .2rem rgba(81, 45, 168, 0.5)
}

.badge-secondary {
  color: #fff;
  background: linear-gradient(to right top, #3043c0, #5f49cc, #8450d7, #a656e1, #c75cea)
}
...
a.badge-secondary:focus, a.badge-secondary.focus {
  outline: 0;
  box-shadow: 0 0 0 .2rem rgba(255, 64, 129, 0.5)
}
...
a.badge-success:focus, a.badge-success.focus {
  outline: 0;
  box-shadow: 0 0 0 .2rem rgba(82, 196, 26, 0.5)
}
...
a.badge-info:focus, a.badge-info.focus {
  outline: 0;
  box-shadow: 0 0 0 .2rem rgba(24, 144, 255, 0.5)
}
...
a.badge-warning:focus, a.badge-warning.focus {
  outline: 0;
  box-shadow: 0 0 0 .2rem rgba(250, 140, 22, 0.5)
}
...
a.badge-dark:focus, a.badge-dark.focus {
  outline: 0;
  box-shadow: 0 0 0 .2rem rgba(33, 33, 33, 0.5)
}
...
.dt-entry__header:after {
  ...
  height: 3px;
  width: 45px;
  background-color: rgba(1, 1, 23, 0.714);
  border-radius: 10px
}
...
.customizer-toggle a {
  ...
  border-top-left-radius: 50px;
  border-bottom-left-radius: 50px;
  box-shadow: 10px 0px 15px 5px rgb(0 0 0 / 20%);
  display: flex;
  align-items: center;
  justify-content: center;
  height: 2.8rem;
...
.customizer__header {
  ...
  padding: 1rem;
  min-height: 72px;
  box-shadow: 0 2px 2px 0 rgb(117 117 117 / 10%);
}

.customizer__header h3 {
  font-size: 1.8rem;
}

.customizer__header .close {
  margin-left: auto;
  font-size: 3.5rem;
  font-weight: normal;
  line-height: 0.8;
...
.customizer__header .close:focus{
  outline: 0;
}
...
.customizer__body-inner {
  padding: 3rem 2rem;
}

.customizer__body-inner h4 {
  font-size: 15px;
}
...
<div class="dt-content-wrapper" style="background-color: rgba(1, 1, 23, 0.714);">
    <!-- Site Content -->
    <div class="dt-content" style="background-color: rgba(1, 1, 23, 0.714);">
        <!-- Profile -->
        <div class="profile"style="    background-color: rgba(1, 1, 23, 0.714);">
            <!-- Profile Banner -->
            <div class="profile__banner">
                ...
                <div class="dt-page__header">
                    ...
                    Withdrawals                    </h1>
                                                                    <a href="" class="btn btn-dark btn-sm display-i ft-right"> Approved:  USD   {{ DB::table('withdrawals')->where("user_id",$user->id)->where('status','paid')->sum('amount') }} </a>
                ...
                <!-- /page header -->
                <div class="profile__banner-detail" style="background-color: rgba(1, 1, 23, 0.714);">
                    <!-- Avatar Wrapper -->
                    <div class="col-12">
                        <div class="row">
                                                        <!-- Grid Item -->
                            <div class="col-sm-6 col-12">
                                ...
                                <div class="dt-card dt-card__full-height text-dark">
                                    ...
                                    <!-- Card Body -->
                                    <div class="dt-card__body p-xl-8 py-sm-8 py-6 px-4" style="background-color: rgba(1, 1, 23, 0.714);color:white;">
                                        ...
                                        <div class="media">
                                            ...
                                            <div class="media-body">
                                                <div class="display-3 font-weight-600 mb-1 init-counter">
                                                  @if (count($deposits)>0)       
         $ {{ DB::table('withdrawals')->where("user_id",$user->id)->where('status','pending')->sum('amount') }}
			                                 </p>
                                             @else
                            ...
                            <div class="col-sm-6 col-12">
                                ...
                                <div class="dt-card dt-card__full-height text-dark">
                                         @if (count($deposits)>0)
											...
											${{ DB::table('withdrawals')->where("user_id",$user->id)->where('status','paid')->sum('amount') }} 
  ...
  <thead>
    <tr style="color:white;">
      ...
      <th style="color:white;" scope="col">Withdrawal Method</th>
       <th style="color:white;" scope="col">Receiving Address</th>
    ...
    <div class="table-responsive dataTables_wrapper dt-bootstrap4">
                                    <div class="table-responsive">
                                            ...
                                            <h1 style="color:white;">No transactions can be found</h1>
                                        </div>
                                                                            </div>
                                    <!-- /tables -->
