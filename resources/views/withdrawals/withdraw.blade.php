                                ...
                                <div class="dt-card dt-card__full-height text-dark">
                                    ...
                                    <div class="dt-card__body p-xl-8 py-sm-8 py-6 px-4">
                                        ...
                                        <div class="media">
                                            ...
                                            <img style="width:55px;" src="https://imgs.search.brave.com/heTRnCtFPHMUEETQuXHa7wMAC7GskaOq6CXne-mh9DA/rs:fit:766:225:1/g:ce/aHR0cHM6Ly90c2U0/Lm1tLmJpbmcubmV0/L3RoP2lkPU9JUC5v/UlpLLS1tSWszVzFQ/X2pKRHVQQWV3SGFF/bCZwaWQ9QXBp">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-12" id="with-step-1">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="input-group">
                                                                 <input required type="number" class="form-control myElements" max="{{ $totalEarnings }}" step="any" name="amount"
                                                                value="" id="amount" required
                                                            ...
                                                            <label for="amount">Enter receiving method address</label>
                                                            <div class="input-group">
                                                                <input type="text" class="form-control myElements" step="any" name="account_name"
                                                                value="" id="amount" required
                                                                placeholder="">
                                                                <div class="input-group-prepend hide" id="tr-ref-sel">
                                                                    <span class="input-group-text" id="inputGroupPrepend2"></span>
                                                            ...
                                                            <div class="form-group">
                                                                <label for="amount">Withdrawal Method</label>
                                                                <div class="input-group">
                                                                    <select required name="withdrwa_method" id=""  style="width:200px;padding:10px;border-radius: 4px;outline:none;color:gray;">
                                                                        <option value="btc">btc</option>
                                                                        <option value="etherum">eth</option>
                                                                        <option value="ussdt">USDT</option>
                                                                    </select>
                                                                </div>
